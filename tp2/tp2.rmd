...
We now find the best $\lambda$ by using the GCV (Generalized Cross Validation) value. The graph below is a plot of GCV against $\lambda$.
...
We then refit the model with the best $\lambda$ value.
