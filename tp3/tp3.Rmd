...
for (i in 1:5) {
  ...
  sum_accuracy <- avg_accuracy + perf_fold$accuracy
  sum_precision <- avg_precision + perf_fold$precision
  sum_recall <- avg_recall + perf_fold$recall
  sum_specificity <- avg_specificity + perf_fold$specificity
}
