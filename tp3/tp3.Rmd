...
cat("\nAverage accuracy:", sum_accuracy/5, "\n")
cat("Average precision:", sum_precision/5, "\n")
cat("Average recall:", sum_recall/5, "\n")
cat("Average specificity:", sum_specificity/5, "\n")
```
The results obtained above are values related to the performance of the model of each fold, as well as the average values of the 5 folds. (Describe average value compare with first method: increase or decrease)
...
```{r}
res_lasso <- glmnet(as.matrix(train_data[,-11]), train_data$YBin, family="binomial", alpha=1, lambda=best_lasso_lambda)
coef(res_lasso)
```
