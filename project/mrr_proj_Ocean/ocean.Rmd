...
my_plot <- function(perf_data, perf_type, method) {
  ...
  if (perf_type == "RMSE") {
    res <- res + geom_point(size=2, color="darkorange1")
  }
  else {
    res <- res + geom_point(size=2, color="darkcyan")
  }
  return(res)
}
```
...
```{r}
plot(r_squared_bats_linear)
plot(r_squared_bats_forward)
plot(r_squared_bats_ridge)
plot(r_squared_bats_lasso)
```
...
```{r}
plot(r_squared_bats_prev_linear)
plot(r_squared_bats_prev_forward)
plot(r_squared_bats_prev_ridge)
plot(r_squared_bats_prev_lasso)
```
...
```{r}
plot(r_squared_linear)
plot(r_squared_forward)
plot(r_squared_ridge)
plot(r_squared_lasso)
```
